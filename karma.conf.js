...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'app/bower_components/videogular-controls/app/scripts/com/2fdevs/videogular/plugins/controls.js',
      'app/bower_components/videogular-overlay-play/overlay-play.js',
      'app/bower_components/ng-debounce/angular-debounce.js',
      'app/bower_components/videogular-overlay-play/overlay-play.js',
      'app/bower_components/videogular-autohide-cursor/hide-cursor.js',
      'app/scripts/*.js',
      'app/scripts/**/*.js',
      'test/mock/**/*.js',
      'test/spec/**/*.js'
